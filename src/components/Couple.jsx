  ...
  return (
    <section id="couple">
      <div className="couple-wrapper">
        ...
        ></Particles>
        <h1 className="title-quote">Happy Couple Going To Be Enagaged</h1>
        ...
        <div className="row">
          ...
          <div className="col-lg-5" data-aos="fade-up">
            ...
            <div className="info bride-info">
              ...
              <p className="mt-2 mt-lg-3">
                Paternal Grand D/O Janab <strong>G. Mahaboob Sahab,</strong>
              </p>
              <p className="mt-1 mt-lg-2">
                Maternal Grand D/O Janab <strong>M. Mahboob Sahab.</strong>
              </p>
              {/* <p className="mt-1 mt-lg-2">
